...
void DOGMRosConverter::toDOGMMessage(rclcpp::Time time, const dogm::DOGM& dogm, const std::string& frame,
                                     dogm_msgs::msg::DynamicOccupancyGrid& message, bool show_debug)
{
    message.header.stamp.sec = time.seconds();
    message.header.stamp.nanosec = time.nanoseconds();
...
void DOGMRosConverter::toOccupancyGridMessage(rclcpp::Time time, const dogm::DOGM& dogm, const std::string& frame,
                                              nav_msgs::msg::OccupancyGrid& message, bool show_debug)
{
