...
namespace dogm_msgs {
template <class ContainerAllocator> struct GridMapInfo_ {
  typedef GridMapInfo_<ContainerAllocator> Type;

  GridMapInfo_() : resolution(0.0), length(0.0), size(0), pose() {}
  GridMapInfo_(const ContainerAllocator &_alloc)
      : resolution(0.0), length(0.0), size(0), pose(_alloc) {
    (void)_alloc;
  }
  ...
  typedef boost::shared_ptr<::dogm_msgs::GridMapInfo_<ContainerAllocator> const>
      ConstPtr;
...
operator<<(std::ostream &s,
           const ::dogm_msgs::GridMapInfo_<ContainerAllocator> &v) {
  ros::message_operations::Printer<
      ::dogm_msgs::GridMapInfo_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dogm_msgs::GridMapInfo_<ContainerAllocator1> &lhs,
                const ::dogm_msgs::GridMapInfo_<ContainerAllocator2> &rhs) {
  return lhs.resolution == rhs.resolution && lhs.length == rhs.length &&
         lhs.size == rhs.size && lhs.pose == rhs.pose;
}
...
struct IsFixedSize<::dogm_msgs::GridMapInfo_<ContainerAllocator>> : TrueType {};
...
template <class ContainerAllocator>
struct IsMessage<::dogm_msgs::GridMapInfo_<ContainerAllocator>> : TrueType {};
...
template <class ContainerAllocator>
struct HasHeader<::dogm_msgs::GridMapInfo_<ContainerAllocator>> : FalseType {};
...
struct MD5Sum<::dogm_msgs::GridMapInfo_<ContainerAllocator>> {
  static const char *value() { return "e187ade6551b6a67abc91fee215b4147"; }

  static const char *
  value(const ::dogm_msgs::GridMapInfo_<ContainerAllocator> &) {
    return value();
  }
...
struct DataType<::dogm_msgs::GridMapInfo_<ContainerAllocator>> {
  static const char *value() { return "dogm_msgs/GridMapInfo"; }
...
template <class ContainerAllocator>
struct Serializer<::dogm_msgs::GridMapInfo_<ContainerAllocator>> {
...
struct Printer<::dogm_msgs::GridMapInfo_<ContainerAllocator>> {
  ...
  static void stream(Stream &s, const std::string &indent,
    ...
    s << indent << "pose: ";
    s << std::endl;
    Printer<::geometry_msgs::Pose_<ContainerAllocator>>::stream(
        s, indent + "  ", v.pose);
  }
};
