...
namespace dogm_msgs {
template <class ContainerAllocator> struct GridCell_ {
  typedef GridCell_<ContainerAllocator> Type;

  GridCell_()
      : free_mass(0.0), occ_mass(0.0), mean_x_vel(0.0), mean_y_vel(0.0),
        var_x_vel(0.0), var_y_vel(0.0), covar_xy_vel(0.0) {}
  ...
  typedef boost::shared_ptr<::dogm_msgs::GridCell_<ContainerAllocator> const>
      ConstPtr;
...
std::ostream &operator<<(std::ostream &s,
                         const ::dogm_msgs::GridCell_<ContainerAllocator> &v) {
  ros::message_operations::Printer<
      ::dogm_msgs::GridCell_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::dogm_msgs::GridCell_<ContainerAllocator1> &lhs,
                const ::dogm_msgs::GridCell_<ContainerAllocator2> &rhs) {
  return lhs.free_mass == rhs.free_mass && lhs.occ_mass == rhs.occ_mass &&
         lhs.mean_x_vel == rhs.mean_x_vel && lhs.mean_y_vel == rhs.mean_y_vel &&
         lhs.var_x_vel == rhs.var_x_vel && lhs.var_y_vel == rhs.var_y_vel &&
...
struct IsFixedSize<::dogm_msgs::GridCell_<ContainerAllocator>> : TrueType {};
...
template <class ContainerAllocator>
struct IsMessage<::dogm_msgs::GridCell_<ContainerAllocator>> : TrueType {};

template <class ContainerAllocator>
struct IsMessage<::dogm_msgs::GridCell_<ContainerAllocator> const> : TrueType {
};

template <class ContainerAllocator>
struct HasHeader<::dogm_msgs::GridCell_<ContainerAllocator>> : FalseType {};

template <class ContainerAllocator>
struct HasHeader<::dogm_msgs::GridCell_<ContainerAllocator> const> : FalseType {
};

template <class ContainerAllocator>
struct MD5Sum<::dogm_msgs::GridCell_<ContainerAllocator>> {
  static const char *value() { return "aeedeb952081429bea02cba959265ec9"; }

  static const char *value(const ::dogm_msgs::GridCell_<ContainerAllocator> &) {
    return value();
  }
...
struct DataType<::dogm_msgs::GridCell_<ContainerAllocator>> {
  static const char *value() { return "dogm_msgs/GridCell"; }
...
template <class ContainerAllocator>
struct Serializer<::dogm_msgs::GridCell_<ContainerAllocator>> {
