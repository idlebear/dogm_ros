...
namespace info_gain {
enum FlowMethod { bilinear, nearest };

enum FlowOutput { singular, cummulative };
...
public:
    ...
    Eigen::ArrayXXf step(const Eigen::ArrayXXf& occupancy, const VelocityGroup& velocity_group, const ArrayGroup& score,
                         float dt) const;
